  ...
  <div class="container">
    ...
    <div id="search">
      <form method="post" action="?mod=search">
        <input type="text" autocomplete="off" name="keyword" placeholder="Tìm : tên phim, đạo diễn, diễn viên" class="keyword">
...
<?php if(empty($_SESSION["username"])){?>
  ...
  <!-- register.php -->
  <div class="links"><a rel="nofollow" href="#">Đăng ký thành viên</a></div>
